...
export const BUMDES_HEAD = [
  ...
  { id: 'input_laporan', label: 'Input Laporan Keuangan BUM Desa', align: 'left', minWidth: 150 },
  { id: 'input_laporan_unit', label: 'Input Laporan Keuangan Unit', align: 'left', minWidth: 150 },
...
export const BUMDES_DETAIL_HEAD = [
  ...
  { id: 'report', label: 'Status Laporan Keuangan BUM Desa', align: 'center', minWidth: 175 },
  { id: 'report_unit', label: 'Status Laporan Keuangan Unit', align: 'center', minWidth: 175 },
  { id: 'total_omzet', label: 'Total Omzet', align: 'left', minWidth: 200 },
  { id: 'profit_loss', label: 'Laba/Rugi', align: 'left', minWidth: 200 },
  { id: 'total_cash', label: 'Total Kas Tunai', align: 'left', minWidth: 200 },
  { id: 'detail', label: 'Detail', align: 'center', minWidth: 100 },
