        ...
        <CardContent>
          {loading ? (
            ...
            <>
              <Box display="flex" alignItems="center" justifyContent="space-between">
                ...
                <Stack direction="row" alignItems="center">
                  <Rating
                    ...
                    icon={
                      <StarIcon
                        sx={{ color: '#1078CA', fontSize: 'inherit', borderRadius: '50%' }}
                      />
                    }
                    emptyIcon={
                      <StarIcon
                        sx={{ color: '#BBDEFA', fontSize: 'inherit', borderRadius: '50%' }}
                      />
                    }
                  />
              ...
              >
                3 Sep 2023
                <Avatar sx={{ bgcolor: '#BBDEFA', width: '10px', height: '10px', margin: '8px' }}>
                  {' '}
                </Avatar>
                BUM Desa
              </Typography>
              ...
              <Typography
                ...
                paragraph
              >
                Usaha Mikro, Kecil, dan Menengah (UMKM) memiliki peran vital dalam perekonomian
                lokal. Mereka menciptakan lapangan kerja, mendorong pertumbuhan ekonomi, dan menjadi
                tulang punggung perekonomian nasional. Namun, membangun dan mengembangkan UMKM yang
                sukses bukanlah hal yang mudah. Diperlukan strategi, perencanaan, dan kerja keras
                yang matang.
              </Typography>
              <StyledLoadingButton
                variant="contained"
